  ...
  const factors = [
    {
      ...
      description: "Cada corpo tem uma história única que influencia como acumula e perde gordura"
    },
    {
      icon: <Zap className="w-8 h-8 text-medical-primary" />,
      title: "O TIPO específico de gordura",
      description: "Gordura subcutânea e visceral requerem abordagens completamente diferentes"
    },
    {
      icon: <Users className="w-8 h-8 text-medical-primary" />,
      title: "A SINERGIA entre músculo, pele e fáscia",
      description: "O abdômen é um sistema complexo que precisa ser tratado integralmente"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-medical-primary font-semibold">A Verdade Que Ninguém Te Conta</span>
          </div>
          
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-medical-dark">
            A Dor que o <span className="text-medical-primary">Contour</span> Resolve
          </h2>
          
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Sente que <strong>NADA funciona</strong> nessa 'barriguinha' teimosa? 
            <br />Não é culpa sua. Tratamentos genéricos falham porque ignoram 3 fatores cruciais:
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <div className="grid md:grid-cols-3 gap-8">
            {factors.map((factor, index) => (
              <Card key={index} className="text-center p-6 hover:shadow-medium transition-all duration-300 border-0 bg-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center bg-medical-primary/5 rounded-2xl p-8">
            ...
            <p className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto">
              <strong>Nem toda gordura é igual. Nem todo corpo responde da mesma forma.</strong>
              <br />É por isso que você precisa de um método inteligente, preciso e específico.
            </p>
          </div>
        </div>
      </div>
