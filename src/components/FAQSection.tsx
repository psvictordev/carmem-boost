  ...
  const faqs = [
    {
      ...
      answer:
        "Sim! O método Contour utiliza protocolos europeus de bioengenharia estética que permitem reconstruir o abdômen sem cortes, sem anestesia e sem riscos cirúrgicos. Os resultados são visíveis já na primeira semana e comprovados cientificamente.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Sim, o método Contour é especialmente eficaz para correção de diástase abdominal. Utilizamos técnicas específicas que fortalecem a musculatura profunda e aproximam os músculos separados, sem necessidade de cirurgia.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Oferecemos garantia de satisfação. Se após a consulta completa você não se sentir confiante com o plano proposto, pode interromper sem prosseguir com o tratamento. Nossa taxa de satisfação é de 98%.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-16 bg-gradient-to-r from-medical-primary/5 to-orange-100/30 rounded-2xl p-8">
            ...
            <p className="text-gray-600 mb-6">
              Nossa equipe está pronta para esclarecer todas suas questões na
